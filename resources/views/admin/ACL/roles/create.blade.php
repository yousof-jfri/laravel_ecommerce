        ...
        <!-- general form elements -->
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">مقام جدید</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('admin.roles.store') }}" method="POST" role="form">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') invalide @enderror" id="name" name="name" placeholder="اسم مقام را وارد کنید">
                            @error('name')
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('label') invalide @enderror" id="label" name="label" placeholder="توضیحتات مقام را وارد کنید">
                            @error('label')
                                <div class="alert alert-danger mt-3">
